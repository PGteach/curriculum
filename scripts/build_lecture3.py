...
def booklet(head,tail,qr):
 ...
 # ---- the four words: not in the book, but everything later is one of them ----
 p.append(page('<h2>Four words people mix up</h2>'+'<p class="lead">These four are not separated in the textbook, but every AI example in this lesson is one of them. Getting them straight makes the rest easy.</p>'+'<p class="ar">الأربع كلمات دول مش مفصولين في الكتاب، بس كل مثال في الدرس واحد منهم. لو مسكتهم صح الباقي هيبقى سهل.</p>'+dg(FOURTASKS)+'<table><tr><th>Task</th><th>The question it answers</th><th>Where it appears</th></tr><tr><td class="k">Classification</td><td>What is this?</td><td>Spam filter; sorting photos</td></tr><tr><td class="k">Detection</td><td>What, and where?</td><td>A self-driving car reading the road</td></tr><tr><td class="k">Recognition</td><td>Which one is it?</td><td>Unlocking a phone; reading an X-ray</td></tr><tr><td class="k">Generation</td><td>Make a new one</td><td>ChatGPT; image-generation AI</td></tr></table>'+'<div class="summary"><p>The first three take a picture <b>in</b> and give a label <b>out</b>. Only the fourth gives a picture out &mdash; and only that one needs generative AI.</p><p class="ar">التلاتة الأولانيين بياخدوا صورة ويطلّعوا كلام. الرابع بس هو اللي بيطلّع صورة، وهو لوحده اللي محتاج generative AI.</p></div>'))
